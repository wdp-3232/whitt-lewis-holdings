import svgPaths from "./svg-j0fzfr8lzq";
...
function Container41() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[88px] items-start left-[24px] top-[24px] w-[175.406px]" data-name="Container">
      <Button />
      <Button1 />
    </div>
  );
