import svgPaths from "./svg-xpmtdgpk1h";
  ...
  return (
    <div className="h-[22px] relative shrink-0 w-[130.247px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Tinos:Bold',sans-serif] leading-[20px] left-0 not-italic text-[20px] text-white top-[-0.1px] tracking-[-0.5px]">Whitt Lewis</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[17.6px] relative shrink-0 w-[130.247px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Arimo:Bold',sans-serif] font-bold leading-[16px] min-h-px min-w-px relative text-[#99a1af] text-[12px] tracking-[2.4px] uppercase whitespace-pre-wrap">Holdings</p>
      </div>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="content-stretch flex h-[28px] items-center relative shrink-0 w-full" data-name="Heading 2">
      <p className="font-['Tinos:Bold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#1c398e] text-[18px] tracking-[0.45px] uppercase">About Will Pearce</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[118.781px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[19.8px] left-0 text-[#292524] text-[11px] text-justify top-[-2px] w-[474px] whitespace-pre-wrap">What I’m looking for now is the chance to take that work ethic and apply it to something I can own and be accountable for. I’m building Whitt Lewis Holdings to buy one great business and operate it full-time, and to earn trust the same way the best small business owners do, by showing up, doing quality work, and treating people right. If I have the opportunity to carry forward what an owner has built, I’ll focus on protecting the company’s reputation, taking care of employees, and continuing to serve customers well.</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[45px] relative shrink-0 w-[473.547px]" data-name="Heading 2">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pt-[17px] relative size-full">
        <p className="font-['Tinos:Bold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#1c398e] text-[18px] tracking-[0.45px] uppercase">What I Offer as a Buyer</p>
      </div>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[18px] relative shrink-0 w-[154.75px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[18px] left-0 text-[#1c1917] text-[12px] top-[-1px]">Long-term Owner Operator</p>
      </div>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[224.766px]" data-name="Paragraph">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14.438px] left-[10px] text-[#44403b] text-[10.5px] text-justify top-[-1px] w-[215px] whitespace-pre-wrap">I plan to operate the business on-site, day-to-day. I care about protecting the reputation you built and taking care of the people who make it run.</p>
      </div>
    </div>
  );
}
...
function Heading3() {
  return (
    <div className="h-[18px] relative shrink-0 w-[140.656px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[18px] left-0 text-[#1c1917] text-[12px] top-[-1px]">Integrity First Ownership</p>
      </div>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[224.781px]" data-name="Paragraph">
      <div aria-hidden="true" className="absolute border-[#e7e5e4] border-l-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14.438px] left-[10px] text-[#44403b] text-[10.5px] text-justify top-[-1px] w-[215px] whitespace-pre-wrap">I try to do what I say I’m going to do and handle things the right way. My goal is to earn trust over time and be known as a good person to do business with.</p>
      </div>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="h-[18px] relative shrink-0 w-[171.641px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[18px] left-0 text-[#1c1917] text-[12px] top-[-1px]">{`Respect for Customers & Craft`}</p>
      </div>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[57.75px] relative shrink-0 w-[224.766px]" data-name="Paragraph">
      <div aria-hidden="true" className="absolute border-[#e7e5e4] border-l-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14.438px] left-[10px] text-[#44403b] text-[10.5px] text-justify top-[-1px] w-[215px] whitespace-pre-wrap">I understand the value of deep customer relationships and the skill required in your trade. I promise to uphold the standards that made you successful.</p>
      </div>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="h-[18px] relative shrink-0 w-[142.734px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[18px] left-0 text-[#1c1917] text-[12px] top-[-1px]">Continuity for Employees</p>
      </div>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[224.781px]" data-name="Paragraph">
      <div aria-hidden="true" className="absolute border-[#e7e5e4] border-l-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14.438px] left-[10px] text-[#44403b] text-[10.5px] text-justify top-[-1px] w-[215px] whitespace-pre-wrap">I’m not buying a business to reinvent it. If I have the opportunity to step in, it’s because I believe in your team and the way you’ve built the operation, and I plan to keep the people who make it run in place.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[21.5px] relative shrink-0 w-[473.547px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start pt-[8px] relative size-full">
        <p className="flex-[1_0_0] font-['Arimo:Bold',sans-serif] font-bold leading-[13.5px] min-h-px min-w-px relative text-[#a6a09b] text-[9px] tracking-[0.9px] uppercase whitespace-pre-wrap">Confidential • Trusted • Professional</p>
      </div>
    </div>
  );
}
...
function Heading6() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[28px] left-0 text-[#1c1917] text-[18px] top-[-1px]">Will Pearce</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="content-stretch flex h-[16.5px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="flex-[1_0_0] font-['Arimo:Bold',sans-serif] font-bold leading-[16.5px] min-h-px min-w-px relative text-[#79716b] text-[11px] tracking-[0.55px] uppercase whitespace-pre-wrap">{`Founder & Principal`}</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[15.75px] relative shrink-0 w-[146.734px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[15.75px] relative shrink-0 text-[#44403b] text-[10.5px]">Will@WhittLewisHoldings.com</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="h-[15.75px] relative shrink-0 w-[72.234px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[15.75px] relative shrink-0 text-[#44403b] text-[10.5px]">(704) 685-5733</p>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="h-[15.75px] relative shrink-0 w-[55.516px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[15.75px] relative shrink-0 text-[#44403b] text-[10.5px]">Raleigh, NC</p>
      </div>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="h-[15.75px] relative shrink-0 w-[112.141px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[15.75px] relative shrink-0 text-[#44403b] text-[10.5px]">whittlewisholdings.com</p>
      </div>
    </div>
  );
}
...
function Heading7() {
  return (
    <div className="h-[20px] relative shrink-0 w-[188.5px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Tinos:Bold',sans-serif] leading-[20px] left-0 not-italic text-[#1c398e] text-[14px] top-0 tracking-[0.35px] uppercase">Investment Criteria</p>
      </div>
    </div>
  );
}
...
function Heading8() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-[56.969px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Bold',sans-serif] font-bold leading-[16.5px] relative shrink-0 text-[#1c1917] text-[11px]">Geography</p>
      </div>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="absolute content-stretch flex h-[11px] items-start left-0 top-[3px] w-[4.844px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[11px] relative shrink-0 text-[#2b7fff] text-[8px]">●</p>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[63.766px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">North Carolina</p>
    </div>
  );
}
...
function Text9() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[63.406px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">South Carolina</p>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[43.797px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">Tennessee</p>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[33.203px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">Virginia</p>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[161.344px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">Open to other states in the Southeast</p>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[244.438px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start justify-center pl-[11px] pr-px py-px relative size-full">
        <Container33 />
        <List />
      </div>
    </div>
...
function Heading9() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-[82.641px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Bold',sans-serif] font-bold leading-[16.5px] relative shrink-0 text-[#1c1917] text-[11px]">Financial Profile</p>
      </div>
    </div>
  );
}
...
function Text17() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[153.969px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">{`$400K - $1.25M of owners' earnings`}</p>
    </div>
  );
}
...
function Text19() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[95.609px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] min-h-px min-w-px relative text-[#57534d] text-[9.5px] whitespace-pre-wrap">History of profitability</p>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[162.875px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">Low capital expenditure requirements</p>
    </div>
  );
}
...
function Text23() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[162.469px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">{`No single customer > 20% of revenue`}</p>
    </div>
  );
}
...
function Heading10() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-[111.578px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Bold',sans-serif] font-bold leading-[16.5px] relative shrink-0 text-[#1c1917] text-[11px]">{`Management & Team`}</p>
      </div>
    </div>
  );
}
...
function Text25() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[107.781px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">Owner seeking transition</p>
    </div>
  );
}
...
function Text27() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[141.844px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">Strong leaders staying post close</p>
    </div>
  );
}
...
function Text29() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[110.781px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">Dedicated employee base</p>
    </div>
  );
}
...
function Text31() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[81.828px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">Culture of integrity</p>
    </div>
  );
}
...
function Heading11() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-[75.719px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Bold',sans-serif] font-bold leading-[16.5px] relative shrink-0 text-[#1c1917] text-[11px]">Industry Focus</p>
      </div>
    </div>
  );
}
...
function Text33() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[103.016px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">Industrial / B2B services</p>
    </div>
  );
}
...
function Text35() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[83.531px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">Residential services</p>
    </div>
  );
}
...
function Text37() {
  return (
    <div className="absolute content-stretch flex h-[13.063px] items-start left-[10.84px] top-0 w-[82.906px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[13.063px] relative shrink-0 text-[#57534d] text-[9.5px]">Healthcare services</p>
    </div>
  );
}
...
function Container40() {
  return (
    <div className="bg-[#e7e5e4] h-[38.5px] relative shrink-0 w-[276.438px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Arimo:Regular',sans-serif] font-normal leading-[13.5px] left-[138.69px] text-[#79716b] text-[9px] text-center top-[11px] w-[117px] whitespace-pre-wrap">© 2026 Whitt Lewis Holdings</p>
      </div>
    </div>
  );
}
...
function Icon13() {
  return (
    <div className="absolute left-[20.75px] size-[16px] top-[10px]" data-name="Icon">
...
function Button() {
  return (
    <div className="bg-white h-[36px] relative rounded-[8px] shrink-0 w-[175.406px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#e7e5e4] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon13 />
        <p className="-translate-x-1/2 absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[104.25px] text-[#44403b] text-[14px] text-center top-[6px]">Back to Website</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-[#193cb8] flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] w-[175.406px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon14 />
        <p className="-translate-x-1/2 absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[104px] text-[14px] text-center text-white top-[6px]">Save as PDF / Print</p>
      </div>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[88px] items-start left-[24px] top-[128px] w-[175.406px]" data-name="Container">
      <Button />
      <Button1 />
    </div>
  );
...
export default function OnePagerLetterHead() {
  return (
    <div className="bg-white relative size-full" data-name="One-Pager & Letter Head">
      <PY />
      <Container41 />
    </div>
  );
